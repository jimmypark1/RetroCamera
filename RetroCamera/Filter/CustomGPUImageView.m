//
//  CustomGPUImageView.m
//  iBeautyCameraSwift
//
//  Created by Junsung Park on 2018. 5. 11..
//  Copyright © 2018년 Junsung Park. All rights reserved.
//

#import "CustomGPUImageView.h"

@interface CustomGPUImageView()
{
...
@implementation CustomGPUImageView
...
- (void)newFrameReadyAtTime:(CMTime)frameTime atIndex:(NSInteger)textureIndex;
{
    ...
    runSynchronouslyOnVideoProcessingQueue(^{
        ...
        glVertexAttribPointer(displayTextureCoordinateAttribute, 2, GL_FLOAT, 0, 0, [CustomGPUImageView textureCoordinatesForRotation:inputRotation]);
