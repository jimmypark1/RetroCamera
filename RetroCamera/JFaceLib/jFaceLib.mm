...
{
    faceScene =  generateScene2([sceneName UTF8String],[filterName UTF8String],[stickerName UTF8String],[self.earringName UTF8String],[self.glassesName UTF8String],[self.hatName UTF8String],[self.mustacheName UTF8String],bOpenEyes,bBigEyes,bVline,rType);
    faceScene->init(binaryFace.session, binaryFace.contextInfo.num_feature_points,"",true);
    targets.push_back(faceScene);
}
